...
export default function ContractAddressesContent() {
  ...
  const contracts = [
    ...
    { network: 'Base', address: '0x946f8b0ef009f3f5b1b35e6511a82a58b09d8d4e', icon: '/partner-logos/base-square-2025.jpeg', explorer: 'https://basescan.org/token/0x946f8b0ef009f3f5b1b35e6511a82a58b09d8d4e' },
