  ...
  const menuItems: MenuItem[] = [
    ...
    { 
      ...
      subItems: [
        ...
        // Temp hidden - { name: intl.formatMessage({ id: "header.airdrop" }), href: '/our-token/airdrop', external: false, description: intl.formatMessage({ id: "header.airdrop.description" }) },
