...
export default function Partners() {
  const partners = [
    ...
    { name: 'Polygon', logo: '/partner-logos/Polygon_Primary_Dark.svg', url: 'https://polygon.technology/' },
    { name: 'Base', logo: '/partner-logos/base2025.svg', url: 'https://base.org' },
    { name: 'The Graph', logo: '/partner-logos/thegraph.svg', url: 'https://thegraph.com/' },
    { name: 'CoinGecko', logo: '/partner-logos/cg2025.svg', url: 'https://www.coingecko.com/' },
